...
Based on *Handrail Design Document*, Draft v0.2. This README summarizes the proposed architecture and roadmap; it does not imply that the described capabilities have been implemented.
